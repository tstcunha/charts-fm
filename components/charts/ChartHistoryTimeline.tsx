...
export default function ChartHistoryTimeline({
  history,
  groupId,
  chartType,
  ...
  return (
    <div className="bg-white/40 backdrop-blur-xl rounded-xl p-6 border border-white/30" style={{ overflow: 'visible' }}>
      ...
      <div className="relative" style={{ overflow: 'visible' }}>
        ...
        {/* Timeline items */}
        <div className="relative flex items-center gap-4 overflow-x-auto overflow-y-visible pb-12 pl-8" style={{ zIndex: 1, overflow: 'visible' }}>
          {timelineItems.map((item, index) => {
            if (item.type === 'bubble') {
              return (
                <div key={index} className="relative flex flex-col items-center flex-shrink-0" style={{ overflow: 'visible' }}>
                  <PositionBubble
              ...
              return (
                <div key={index} className="px-4 py-2 text-sm text-gray-600 italic flex-shrink-0">
