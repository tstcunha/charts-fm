    ...
    return (
      <div>
        ...
        <div className="bg-[var(--theme-background-from)] rounded-xl shadow-sm p-12 text-center border border-theme">
          ...
          <p className="text-gray-700 text-lg mb-2 font-medium">{t('noTrendsAvailable')}</p>
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-5 border border-theme shadow-sm">
          <div className="text-sm text-gray-600 mb-1">{t('biggestClimber')}</div>
          {biggestClimbers.length > 0 ? (
            ...
            <div className="text-lg font-bold text-gray-400">{t('none')}</div>
          )}
        </div>
      </div>
        ...
        return (
          <div className={`relative bg-white/80 backdrop-blur-sm rounded-xl p-6 mb-6 border shadow-sm overflow-hidden ${
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className={`text-xl font-bold ${isPeakPosition ? 'text-blue-900' : 'text-[var(--theme-primary-dark)]'}`}>{t('biggestClimber')}</h3>
            </div>
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  {biggestClimbers[0].artist && (
                    <span className={`text-lg font-normal ${isPeakPosition ? 'text-blue-700' : 'text-gray-600'}`}> {t('by', { artist: biggestClimbers[0].artist })}</span>
                  )}
                </Link>
      ...
      {newEntries.length > 0 && (
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm p-6 mb-6 border border-theme">
          <h3 className="text-xl font-bold text-[var(--theme-primary-dark)] mb-4">{t('newEntriesThisWeek')}</h3>
